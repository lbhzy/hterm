...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.quickbar_action = QAction(MainWindow)
        self.quickbar_action.setObjectName(u"quickbar_action")
        self.quickbar_action.setCheckable(True)
        self.quickbar_action.setChecked(True)
        self.trigger_action = QAction(MainWindow)
        self.trigger_action.setObjectName(u"trigger_action")
        icon4 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.MediaPlaylistRepeat))
        self.trigger_action.setIcon(icon4)
        self.statusbar_action = QAction(MainWindow)
        self.statusbar_action.setObjectName(u"statusbar_action")
        ...
        icon5 = QIcon(QIcon.fromTheme(u"address-book-new"))
        self.session_menu.setIcon(icon5)
        ...
        self.menu_2.addAction(self.trigger_action)
        self.menu_2.addSeparator()
        self.menu_2.addAction(self.action_2)
        self.menu_3.addAction(self.left_action)
        self.menu_3.addAction(self.right_action)
        self.menu_3.addAction(self.quickbar_action)
        self.menu_3.addAction(self.statusbar_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.quickbar_action.setText(QCoreApplication.translate("MainWindow", u"\u5feb\u901f\u547d\u4ee4\u680f", None))
        self.trigger_action.setText(QCoreApplication.translate("MainWindow", u"\u89e6\u53d1\u5668", None))
        self.statusbar_action.setText(QCoreApplication.translate("MainWindow", u"\u72b6\u6001\u680f", None))
